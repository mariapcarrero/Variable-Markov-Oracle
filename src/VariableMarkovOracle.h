...
#ifndef FACTORORACLESTRING_VARIABLEMARKOVORACLE_H
#define FACTORORACLESTRING_VARIABLEMARKOVORACLE_H
...
public:
    static void ZeroCrossingsFeatureExtraction(VariableMarkovOracle * audio_oracle, vector<vector<double>> audio_vector,int hop_size) {
    ...
    static void RootMeanSquareFeatureExtraction(VariableMarkovOracle * audio_oracle, vector<vector<double>> audio_vector,int hop_size) {
        vector <vector <double>> vector_real;
    ...
    static void MFCCFeatureExtraction(VariableMarkovOracle * audio_oracle, vector<vector<double>> audio_vector,int hop_size) {
        vector <vector <double>> vector_real;
    ...
    static void PitchFeatureExtraction(VariableMarkovOracle * audio_oracle, vector<vector<double>> audio_vector,int hop_size) {
        vector <vector <double>> vector_real;
    ...
    typedef void (*FnPtr)(VariableMarkovOracle * audio_oracle, vector<vector<double>> audio_vector,int hop_size);
...
public:
     ...
     */
    std::string Operation(VariableMarkovOracle * audio_oracle, vector<vector<double>> audio_vector,int hop_size, const string& feature) {
 ...
 */
void ClientCode(Facade *facade, VariableMarkovOracle * audio_oracle, vector<vector<double>> audio_vector,int hop_size, string feature) {
    // ...
...
int main() {
    VariableMarkovOracle audio_oracle;
...
#endif //FACTORORACLESTRING_VARIABLEMARKOVORACLE_H
